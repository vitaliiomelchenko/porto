...
?>
	...
	<div id="content" role="main">
		...
		<?php else : ?>
			...
			<h2 class="entry-title m-b"><?php esc_html_e( '[:ua]Нічого не знайдено[:en]Nothing found[:ru]Ничего не найдено', 'porto' ); ?></h2>
			...
			<?php elseif ( is_search() ) : ?>
				...
				<p class="alert alert-info"><?php esc_html_e( '[:ua]Вибачте, але нічого не відповідає Вашим умовам пошуку. Будь ласка, спробуйте ще раз з іншими ключовими словами[:en]Sorry, but nothing matches your search conditions. Please try again with other keywords.[:ru]Извините, но ничего не соответствует Вашим условиям поиска. Пожалуйста, попробуйте еще раз с другими ключевыми словами.', 'porto' ); ?></p>
				<?php get_search_form(); ?>
