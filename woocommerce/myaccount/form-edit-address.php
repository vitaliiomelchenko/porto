...
<?php else : ?>
	...
	<form method="post">
		...
		<div class="woocommerce-address-fields">
			...
			<p class="clearfix">
				<button type="submit" class="button btn-lg pt-right" name="save_address" value="<?php esc_attr_e( 'Save address', 'woocommerce' ); ?>"><?php esc_html_e( 'Save address', 'woocommerce' ); ?></button>
