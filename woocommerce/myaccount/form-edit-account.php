...
<form action="" method="post" class="woocommerce-EditAccountForm edit-account" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide form-row_login-input">
	...
	<fieldset class="m-t-lg change-password-cust">
	...
	<p class="clearfix">
		...
		<button type="submit" class="woocommerce-Button button btn-lg pt-right button-with-pseudo" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
