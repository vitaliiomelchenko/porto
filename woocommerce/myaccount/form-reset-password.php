...
<div class="featured-box featured-box-primary align-left">
	<div class="box-content">
		...
		<form method="post" class="woocommerce-ResetPassword lost_reset_password">
			<p><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Введите новый пароль', 'porto') ); ?></p><?php // @codingStandardsIgnoreLine ?>
			...
			<p class="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
				<label for="password_2"><?php esc_html_e( 'Повторно введите новый пароль', 'porto' ); ?>&nbsp;<span class="required">*</span></label>
			...
			<p class="woocommerce-form-row form-row clearfix">
				...
				<button type="submit" class="woocommerce-Button button btn-lg pt-right" value="<?php esc_attr_e( 'Сохранить изменения', 'woocommerce' ); ?>"><?php esc_html_e( 'Сохранить изменения', 'woocommerce' ); ?></button>
			</p>
