				...
				<div class="box-content">
					<form class="woocommerce-cart-form" action="<?php echo esc_url( version_compare( $porto_woo_version, '2.5', '<' ) ? WC()->cart->get_cart_url() : wc_get_cart_url() ); ?>" method="post">
												...
												<?php
													...
													echo apply_filters( 'woocommerce_cart_item_remove_link',
														sprintf(
															...
															esc_attr__( 'Удалить товар', 'porto' ),
															esc_attr( $product_id ),
						...
						<div class="cart-actions">
							<a class="btn btn-default" href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>"><?php esc_html_e( 'Continue shopping', 'woocommerce' ); ?></a>
