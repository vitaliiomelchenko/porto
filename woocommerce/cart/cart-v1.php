				...
				<tr>
					<td colspan="6" class="actions">
						...
						<div class="cart-actions pt-right">
							<button type="submit" class="btn btn-default btn-lg" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_attr_e( 'Update cart', 'woocommerce' ); ?></button>
