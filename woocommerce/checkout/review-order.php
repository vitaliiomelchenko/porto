...
<?php
	...
	if($lang == 'ua') $free = 'Доставка товару та комісія за грошовий перерахунок - <strong>безкоштовно!</strong>';
	if($lang == 'ru') $free = 'Доставка товара и комиссия за перевод денег - <strong>бесплатно!</strong>';
	if($lang == 'en') $free = 'Shipping and commission for money transfer - <strong>free!</strong>';
?>
<div class="checkout-free-notice"><?=$free?></div>