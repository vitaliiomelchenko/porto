...
function porto_search_form() {
	...
	ob_start();
	?>
	<div class="searchform-popup<?php echo isset( $porto_settings['search-layout'] ) && ( 'simple' == $porto_settings['search-layout'] || 'large' == $porto_settings['search-layout'] || 'reveal' == $porto_settings['search-layout'] || 'overlay' == $porto_settings['search-layout'] ) ? ' search-popup' : ''; ?>">
		...
		if ( is_array( $element ) ) {
			...
			foreach ( $element as $key => $value ) {
				if ( 'porto_block' == $key && $value ) {
					...
					echo '<a class="mobile-toggle"><span class="line"></span></a>';
				} elseif ( 'nav-top' == $key ) {
