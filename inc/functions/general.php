...
global $product;
	echo '<div class="wpb_text_column wpb_content_element  promo-slider_detail-block products_detail-block">
			<p><a href="'.esc_url( $product->get_permalink( $product->id )).'" class="detail-link"> Детальніше</a></p>
	</div>';
}
// woocommerce_before_shop_loop_item_title

add_action( 'woocommerce_before_shop_loop_item_title', 'bbloomer_new_badge_shop_page', 12 );
...
function bbloomer_new_badge_shop_page() {
   ...
   if ( ( time() - ( 60 * 60 * 24 * $newness_days ) ) < $created ) {
      echo  '<div class="itsnew">' . esc_html__( 'New', 'woocommerce' ) . '</div>';
   }
}